                ...
                <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300 card-primary card-outline">
                    ...
                    <table id="js-data-tables" class="table-auto mb-4 bg-transparent table-striped table-bordered">
                        <div class="flex py-3">
                            ...
                            <a href="{{route('admin.all.product.orders')}}" class="inline-flex justify-center px-2 py-2 mr-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-green-600 border border-transparent rounded-lg active:bg-green-600 hover:bg-green-700 focus:outline-none focus:shadow-outline-green">{{ __('Clear') }}</a>
                        </div>
                        <thead>
                            <tr>
                                <th>{{ __('#') }}</th>
