            ...
            <div class="lg:w-full pr-4 pl-4">
                    <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300 card-primary card-outline">
                            <div class="flex py-3 px-6 mb-0 bg-gray-200 border-b-1 border-gray-300 text-gray-900">
                                <h3 class="mt-1 w-1/2">{{ __('Add Currency') }}</h3>
                                <div class="flex w-1/2 justify-end">
                                    <a href="{{ route('admin.currency') }}" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            ...
                            <div class="flex-auto p-6">
                                <form class="form-horizontal" action="{{ route('admin.currency.store') }}" method="POST">
                                    ...
                                    <div class="mb-4 flex flex-wrap ">
                                        ...
                                        <div class="sm:w-4/5 pr-4 pl-4">
                                            <input type="text" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" name="sign" placeholder="{{ __('Sign') }}" value="{{ old('sign') }}">
                                            @if ($errors->has('sign'))
                                    ...
                                    <div class="mb-4 flex flex-wrap ">
                                        ...
                                        <div class="sm:w-4/5 pr-4 pl-4">
                                            <input type="text" min="0" step="0.1" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" name="value" placeholder="{{ __('Value') }}" value="{{ old('value') }}">
                                            @if ($errors->has('value'))
