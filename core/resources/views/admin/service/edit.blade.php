            ...
            <div class="lg:w-full pr-4 pl-4">
                    <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300 card-primary card-outline">
                            <div class="flex my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                                <h3 class="px-4 mt-1 w-1/2">{{ __('Edit Offer') }}</h3>
                                <div class="flex w-1/2 justify-end">
                                    <a href="{{ route('admin.service'). '?language=' . $currentLang->code }}" class="inline-flex justify-center py-2 px-4 mr-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            ...
                            <div class="flex-auto p-6">
                                <form class="form-horizontal" action="{{ route('admin.service.update',  $service->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4 flex flex-wrap ">
                                        ...
                                        <div class="sm:w-4/5 pr-4 pl-4">
                                            <img class="w-full mb-3 img-demo show-img" src="{{ asset('assets/front/img/'.$service->icon) }}" alt="">
                                    ...
                                    <div class="mb-4 flex flex-wrap ">
                                        <label class="sm:w-1/5 pr-4 pl-4 control-label">{{ __('Feature Image') }}<span class="text-red-600">*</span> </label>
                                        ...
                                        <div class="sm:w-4/5 pr-4 pl-4">
                                            ...
                                            <p class="help-block text-teal-500">{{ __('Upload 670X418 (Pixel) Size image for best quality.
                                                Only jpg, jpeg, png image is allowed.') }}
                                            </p>
                                            @if ($errors->has('image'))
                                                <p class="text-red-600"> {{ $errors->first('image') }} </p>
                                    ...
                                    <div class="mb-4 flex flex-wrap ">
                                        <label class="sm:w-1/5 pr-4 pl-4 control-label">{{ __('Service Name') }}<span class="text-red-600">*</span></label>
        
                                        <div class="sm:w-4/5 pr-4 pl-4">
                                            <input type="text" name="name" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded"  placeholder="{{ __('Service Name') }}" value="{{ $service->name }}">
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="mb-4 flex flex-wrap ">
                                        ...
                                        <div class="sm:w-4/5 pr-4 pl-4">
                                            <textarea name="content" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded summernote" placeholder="{{ __('Description') }}" rows="7">{{ $service->content }}</textarea>
