...
<div class="content-header">
        <div class="container mx-auto sm:px-4 max-w-full mx-auto sm:px-4">
            ...
            <div class="sm:w-1/2 pr-4 pl-4">
                <h1 class="flex flex-wrap pt-3 pb-3 py-4 px-4 mb-4 bg-gray-200 m-0 text-gray-900">{{ __('Payment Gateway') }}</h1>
            </div><!-- /.col -->
            <div class="sm:w-1/2 pr-4 pl-4">
        ...
        <div class="flex flex-wrap ">
            <div class="md:w-full pr-4 pl-4">
                <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300 card-primary card-outline">
                    ...
                    <h3 class="mt-1 w-1/2">{{ __('Payment Gateway List') }}</h3>
                    </div>
                    <!-- /.card-header -->
                    ...
                    <table id="idtable" class="w-full max-w-full mb-4 bg-transparent table-bordered table-striped data_table">
                        ...
                        <tr>
                            ...
                            <td width="18%">
                                ...
                                <a href="javascript:;" data-href="{{ route('admin.payment.delete', $gateway->id ) }}" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded  no-underline bg-red-600 text-white hover:bg-red-700 py-1 px-2 leading-tight text-xs  delete" data-toggle="modal" data-target=".deleteModel"><i class="fas fa-trash"></i>{{ __('Delete') }}</a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
