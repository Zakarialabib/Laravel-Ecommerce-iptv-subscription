            ...
            <div class="lg:w-full pr-4 pl-4">
                <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300 card-primary card-outline">
                    ...
                    <div class="flex-auto p-6">
                        <form class="form-horizontal" action="{{ route('admin.funfact.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-4 flex flex-wrap ">
                                ...
                                <div class="sm:w-4/5 pr-4 pl-4">
                                    <input type="text" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" name="name" placeholder="{{ __('Enter Fact Name') }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-4 flex flex-wrap ">
                                ...
                                <div class="sm:w-4/5 pr-4 pl-4">
                                    <input type="number" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" name="value" placeholder="{{ __('Enter Fact Value') }}">
                                </div>
                            </div>
                            <div class="mb-4 flex flex-wrap ">
