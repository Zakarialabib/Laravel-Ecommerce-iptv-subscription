        ...
        <div class="lg:w-3/5 pr-4 pl-4">
          <div class="right-area">
            <div class="product-info">
              ...
              @if($product->stock >0)
              <span class="inline-block p-1 text-center font-semibold text-sm align-baseline leading-none rounded bg-green-500 text-white hover:green-600">
                <i class="far fa-check-circle"></i> {{ __('In Stock') }}
              </span>
            @else
            <span class="inline-block p-1 text-center font-semibold text-sm align-baseline leading-none rounded bg-red-600 text-white hover:bg-red-700">
            ...
            @endif
              ...
              <div class="share-product">
                ...
                <div class="tag-social-link ">
                  <!-- AddToAny BEGIN -->
                  <div class="a2a_kit a2a_kit_size_32 a2a_default_style inline-block">
