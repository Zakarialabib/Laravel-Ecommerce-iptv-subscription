						...
						<div class="collapse navbar-collapse fixed-height" id="main_menu">
							<ul class="navbar-nav ml-auto">
								...
								<li class="nav-item">
									...
									@endif" href="{{ route('front.products') }}">
							        {{ __('All Product') }}
									</a>
								</li>
								@endif
								...
								<li class="nav-item">
									<a class="nav-link " href="{{ route('user.dashboard') }}"><i class="fas fa-user"></i> {{ Auth::user()->name }}</a>
								</li>
						    	@else
								<li class="nav-item dropdown">
									...
									<div class=" dropdown-menu">
										...
										<a class="dropdown-item" href="{{ route('user.register') }}">{{ __('Register') }}</a>
									</div>
								</li>
								@endif
							</ul>
